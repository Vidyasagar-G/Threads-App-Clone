  ...
  const handleConversationSearch = async (e) => {
    ...
    try {
      ...
      const conversationAlreadyExists =
        conversations.find(conv => conv.participants[0]._id
          === searchedUser._id)
      if (conversationAlreadyExists) {
        setSelectedConversation({
          _id: conversations.find(
            conv => conv.participants[0]._id === searchedUser._id)._id,
      ...
      >
          ...
          {loadingConversations && (
            [0, 1, 2, 3, 4].map((_, i) => (
              <Flex
                ...
                p={1} borderRadius={"md"}
              >
                <Box w={10} h={10} bg={"gray.200"} borderRadius={"50%"}>
        ...
        {!selectedConversation._id && (
          ...
          >
            ...
            <Text fontSize={20} color={useColorModeValue("gray.600", "gray.400")}>
